...
public class DewpointDecimal implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(DewpointDecimal.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("repr");
        sb.append('=');
