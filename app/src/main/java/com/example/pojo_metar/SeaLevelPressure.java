...
public class SeaLevelPressure implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(SeaLevelPressure.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("repr");
        sb.append('=');
